...
//    int currentState = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            ActivityCompat.requestPermissions(MainActivity_Temp.this, new String[]{RECORD_AUDIO, INTERNET, READ_EXTERNAL_STORAGE}, permissionRequestId);
        }
        catch(Exception ex) {
...
//                });
                ...
                //20.11.26 result 자체에서 문제가 발생한 듯 
                ...
                if (continuousListeningStarted) {
                    if (reco != null) {
                        ...
                        setOnTaskCompletedListener(task, result -> {
                            ...
                            MainActivity_Temp.this.runOnUiThread(() -> {
